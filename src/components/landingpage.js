...
<section className="about-me">
  <div className="section-content">
    <h2>About Me</h2>
      ...
      <p className="paragraph">
          Throughout the development journey, I faced various challenges that fueled my determination to create a
          user-friendly and visually engaging platform. Leveraging my skills in web development and a keen interest in
          data visualization, I crafted an interactive 3D globe that allows users to delve into real-time COVID-19
          statistics across the globe.
      </p>
      <p className="paragraph">
          I invite you to explore the features of the COVID-19 Visualizer, gain insights into the pandemic's footprint,
          and stay informed about the latest data. Thank you for joining me on this journey of combining technology with
          global awareness.
      </p>
  </div>
</section>
